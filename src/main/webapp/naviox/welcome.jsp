...
In proyectouam-labels_en.properties:
proyectouam=My application
proyectouam[description]=My application does this and that

In proyectouam-messages_en.properties:
